...
class ScaffoldWithNavTopbBar extends StatelessWidget {
  /// Constructs an [ScaffoldWithNavTopbBar].
  const ScaffoldWithNavTopbBar({
    required this.navigationShell,
    Key? key,
    required this.width,
    this.narrow = false,
    this.hasLogout = true,
  }) : super(key: key ?? const ValueKey<String>('ScaffoldWithNavTopbBar'));
